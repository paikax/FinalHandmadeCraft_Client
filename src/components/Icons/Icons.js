...
export const WalletIcon = ({ width = '2rem', height = '2rem', className }) => (
    ...
    >
        <path d="M25 10a1 1 0 0 1 1 1v2.47c2.04.3 3.8 1.09 5.25 2.25.39.32.43.9.12 1.3l-.88 1.16c-.36.49-1.07.53-1.56.17a8.58 8.58 0 0 0-2.93-1.4v5.55c3.17.86 6.42 2.2 6.42 6.26 0 3.14-1.98 5.93-6.42 6.5V37a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1.78a11.22 11.22 0 0 1-5.93-2.65.94.94 0 0 1-.11-1.26l.9-1.23c.37-.52 1.12-.55 1.6-.15A9.19 9.19 0 0 0 22 31.77V25.5c-2.99-.84-5.83-2.16-5.83-5.93 0-3.02 2.24-5.46 5.83-6.1V11a1 1 0 0 1 1-1h2Zm1 16.6v5.3c1.83-.44 2.58-1.64 2.58-2.79 0-1.3-1.08-2-2.58-2.52Zm-4-5.23v-4.5c-1.25.4-2 1.27-2 2.42 0 1 .8 1.62 2 2.08Z"></path>
